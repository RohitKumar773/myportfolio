...
const Card = ({image, onBtnClick, projectName, codeLink}) => {
  return (
    ...
    id='card' data-aos="zoom-in-down">
        <img src={image} alt="" className='w-full h-[300px] object-cover' id='img'/>
        <h1 className='w-full h-auto text-center font-bold text-lg mt-2'>{projectName}</h1>

        <button className='w-[200px] ml-[30px] bg-gradient-to-tr from-purple-600 to-red-600 text-white mt-2 p-1 rounded-lg hover:bg-green-800'>
